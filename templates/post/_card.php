<a href="<?php the_permalink(); ?>" title="<?php the_title(); ?>" data-animate="animated zoomIn" class="c-card <?php if( !empty($isEvent) && $isEvent ) : ?>c-card--event<?php else: ?>c-card--default<?php endif; ?> trigger-hover">
